                ...
                <form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-3">
                            ...
                            @if($employee->image_path)
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('/images/' . $employee->image_path) }}" alt="Employee Image" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px;">
                                </div>
                            @else
                        ...
                        <div class="mt-3">
                            ...
                            <div class="d-flex align-items-center">
                                <img id="imagePreview" src="#" alt="New Image Preview" class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover; border-radius: 8px; display: none;">
                            </div>
                        </div>
                    </div>
                    </div>
